import { Icons, IconTypes, IconKinds } from './types'
import { iconSets, prefixes, IconSetsNames, IconSets, IconsWithTypes } from './data'
...
export const getIconUrl = <P extends keyof IconSets<IconSetsNames>, T extends IconTypes[P & keyof IconTypes]>(
  ...
  return origin + '/' + iconSets[props.set].replace(/{(.*?)}/g, (_, key) => values[key as never] as string)
}
